...
<div class="login-screen">
    ...
    <div class="login-card">
        <div class="login-card__inner">
            ...
            <h1 class="login-card__welcome">Welcome back to <strong>Apprumo</strong></h1>
            ...
            <form class="login-form" method="post" action="<?= base_url('auth/login') ?>" data-disable-on-submit>
                ...
                <div class="login-field">
                    ...
                    <input id="login_email" name="email" type="email" required autocomplete="email" placeholder="Corporate Email or Username" value="<?= e(old('email', '')) ?>">
                </div>
                ...
                <div class="login-field login-field--password">
                    ...
                    <input id="login_password" name="password" type="password" required autocomplete="current-password" placeholder="Password">
                    <button class="login-field__toggle" type="button" data-toggle-password aria-label="show password">
                    ...
                    <span class="login-field__hint" data-toggle-password-label>show password</span>
                </div>
            ...
            <div class="login-card__links">
                <a href="<?= e($supportUrl) ?>" target="_blank" rel="noopener">Forgot password?</a>
                <a href="<?= base_url('register') ?>">Request access (Create account)</a>
            </div>
